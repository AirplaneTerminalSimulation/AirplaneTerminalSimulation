...
public class Form1 : Form
{
    ...
    private RadioButton radio_button_garage1, radio_button_garage2, radio_button_random_garage1;
    ...
    private void InitializeComponent()
    {
            ...
            this.radio_button_random_garage1 = new System.Windows.Forms.RadioButton();
            ...
            this.radio_button_garage1.BackColor = System.Drawing.Color.Transparent;
            ...
            this.radio_button_garage1.UseVisualStyleBackColor = false;
            // 
            // radio_button_garage2
            // 
            this.radio_button_garage2.AutoSize = true;
            this.radio_button_garage2.BackColor = System.Drawing.Color.Transparent;
            ...
            this.radio_button_garage2.UseVisualStyleBackColor = false;
            // 
            // button_garage1
            // 
            ...
            // radio_button_random_garage1
            // 
            this.radio_button_random_garage1.AutoSize = true;
            this.radio_button_random_garage1.BackColor = System.Drawing.Color.Transparent;
            this.radio_button_random_garage1.Checked = true;
            this.radio_button_random_garage1.Location = new System.Drawing.Point(592, 360);
            this.radio_button_random_garage1.Name = "radio_button_random_garage1";
            this.radio_button_random_garage1.Size = new System.Drawing.Size(96, 17);
            this.radio_button_random_garage1.TabIndex = 15;
            this.radio_button_random_garage1.TabStop = true;
            this.radio_button_random_garage1.Text = "random garage";
            this.radio_button_random_garage1.UseVisualStyleBackColor = false;
            // 
            // Form1
            // 
            ...
            this.Controls.Add(this.radio_button_random_garage1);
...
public class CrossingType2PanelThread
{
    ...
    private Semaphore semaphore;
    private Buffer buffer;
    private RadioButton radio_button_garage1;
    private RadioButton radio_button_garage2;
    private RadioButton radio_button_random_garage1;
    private Semaphore next_semaphore1;
    private Buffer next_buffer1;
    private Semaphore next_semaphore2;
    private Buffer next_buffer2;
    ...
    public CrossingType2PanelThread(Point origin,
                       ...
                       Semaphore semaphore,
                       Buffer buffer,
                       RadioButton radio_button_garage1,
                       RadioButton radio_button_garage2,
                       RadioButton radio_button_random_garage1,
                       Semaphore next_semaphore1,
                       Buffer next_buffer1,
                        Semaphore next_semaphore2,
                       Buffer next_buffer2)
    {
        ...
        this.semaphore = semaphore;
        this.buffer = buffer;
        this.radio_button_garage1 = radio_button_garage1;
        this.radio_button_garage2 = radio_button_garage2;
        this.radio_button_random_garage1 = radio_button_random_garage1;
        this.next_semaphore1 = next_semaphore1;
        this.next_buffer1 = next_buffer1;
        this.next_semaphore2 = next_semaphore2;
        this.next_buffer2 = next_buffer2;
    ...
    public void Start()
    {
        ...
        while (true)
        {
            ...
            /* les lignes qui changent tout */
            if (radio_button_garage1.Checked)
            {
                next_semaphore1.Wait();
                next_buffer1.Write(this.colour);
            }
            ...
            {
                if (radio_button_garage2.Checked)
                {
                    next_semaphore2.Wait();
                    next_buffer2.Write(this.colour);
                }
